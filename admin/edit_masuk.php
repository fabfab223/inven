...
if(isset($_GET['pesan'])){
	...
	if($pesan=="oke"){
		...
		echo "<a class='btn' href='input.php'><span class='glyphicon glyphicon-arrow-left'></span>  Kembali</a>";
	}
	else{
...
$det=mysqli_query($conn,"select * from barang_masuk where id='$id_brg'")or die(mysql_error());
