...
$pdf->Cell(4, 0.8, 'Nama Peminta', 1, 0, 'C');
$pdf->Cell(3, 0.8, 'Jumlah', 1, 1, 'C');
$pdf->SetFont('Arial','',10);
$no=1;
$nama=$_GET['nama_peminta'];
$id=$_GET['id'];
$query=mysqli_query($conn,"select * from barang_keluar where nama_peminta ='$nama' and id='$id'");
...

{
	...
	$pdf->Cell(4, 0.8, $lihat['nama_peminta'],1, 0, 'C');
