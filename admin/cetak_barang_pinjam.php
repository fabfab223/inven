...
$pdf->Cell(3, 0.8, 'Nama Peminta', 1, 0, 'C');
...
$query=mysqli_query($conn,"select * from barang_pinjam where nama_barang ='$nama' AND tanggal>='$tanggal1' AND tanggal<='$tanggal2'");
...
$pdf->Output("laporan_pinjam_barang.pdf","I");
