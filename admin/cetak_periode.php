...
$pdf->Cell(25.5,0.7,"Laporan Barang Keluar",0,10,'C');
$pdf->ln(1);
$pdf->SetFont('Arial','B',10);
...
$tanggal=$_POST['tgl'];
$tanggal2=$_POST['tgl2'];
$query=mysqli_query($conn,"select * from barang_keluar where tanggal>= '$tanggal' and tanggal<='$tanggal2' order by tanggal");
