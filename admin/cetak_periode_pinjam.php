...
$pdf->Cell(5.6, 0.8, 'Nama Peminta', 1, 0, 'C');
...
$tanggal=$_POST['tgl'];
$tanggal2=$_POST['tgl2'];
$query=mysqli_query($conn,"select * from barang_pinjam where tanggal>= '$tanggal' and tanggal<='$tanggal2' order by tanggal");
...

{
	...
	$pdf->Cell(5.6, 0.8, $lihat['nama_peminta'],1, 0, 'C');
...
$pdf->Output("laporan_pinjam_periode.pdf","I");
